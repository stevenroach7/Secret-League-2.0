...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'ionic-timepicker', 'rzModule'])
...
.run(function($ionicPlatform) {
  $ionicPlatform.ready(function() {
    ...
    if (window.cordova && window.cordova.plugins && window.cordova.plugins.Keyboard) {
      cordova.plugins.Keyboard.hideKeyboardAccessoryBar(false); // Shows done button in select element
